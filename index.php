...
_Hasync.push(['Histats.start', '1,5030066,4,511,95,18,00000000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5030066&101" alt="free counter" border="0"></a></noscript>
<!-- Histats.com  END  -->
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Home eCommerce Bootstrap HTML Template - Furnish</title>
  </head>
  <body>
...
<main>
 <div class="py-lg-8 pt-6">
              ...
              <!--Slider-->
							<div class="swiper-slide px-md-8 ">
								<div class="position-relative text-center">
									...
									<img src="./assets/images/slider/slider-img-2.png" alt="" class="img-fluid my-5 my-lg-0">
          ...
          <h2 class="display-4 lh-1">Comfy Sofa Home-Office
           ...
           <div class="position-absolute top-md-65 top-75 start-50 translate-middle-x mt-lg-9 ">
            ...
            <a href="#" class="btn btn-primary">View Details</a>
							...
							<div class="swiper-slide px-md-8 ">
								<div class="position-relative text-center">
                  <img src="./assets/images/slider/slider-img-1.png" alt="" class="img-fluid my-5 my-lg-0">
                   <div class="text-center position-absolute top-0 start-0 px-lg-11   ">
              ...
              <!--Slider-->
							<div class="swiper-slide px-md-8 ">
								<div class="position-relative text-center">
									...
									<img src="./assets/images/slider/slider-img-3.png" alt="" class="img-fluid my-5 my-lg-0">
                   <div class="text-center position-absolute top-0 start-0 px-lg-11   ">
  ...
  <!--New arrival start-->
	...
	<!--New arrival end-->
  <section  style="background: url(./assets/images/couch-with-cushions-glass-table.jpg)no-repeat; background-size: cover; background-position: center;" class="py-lg-11 py-6">
    <div class="container">
    ...
    <div class="container ">
      ...
      <span>Template</span>
          ...
          <div class="col-md-6 text-center text-md-start">
            <p class=" mb-0">&copy; 2025 Furnish. Developed by <a href="https://codescandy.com" class="text-white" target="_blank">CodesCandy</a> • Distributed by <a href="https://themewagon.com" class="text-white" target="_blank">ThemeWagon</a>. All rights reserved.</p>
          </div>
